...
class Course {
    ...
    public void addStudent(String name, int id) {
        ...
        students.add(new Student(name, formattedId));
    }
    ...
    public void updateGrade(String studentId, int testNumber, int newScore) {
        for (Student student : students) {
            if (student.getId().equals(studentId)) {
                ...
                System.out.println("Error, no test with number " + testNumber + " for student with id '" + studentId + "'.");
                return;
            }
        }
        System.out.println("Error, no student with id '" + studentId + "' registered in this class.");
...
public class Problem1 {
    public static void main(String[] args) {
        ...
        cs176l.addStudent("Cream", 1);
        cs176l.addStudent("Oreo", 2);
        cs176l.addStudent("Derek", 3);
        ...
        System.out.print("Enter test number to update: ");
        int testNumberToUpdate = scanner.nextInt();
        System.out.print("Enter new score: ");
        int newScore = scanner.nextInt();
        cs176l.updateGrade(studentIdToUpdate, testNumberToUpdate, newScore);
